...
(function ($) {
    ...
    ace.general_things = function (a) {
        ...
        a("#skin-colorpicker").on("change", function () {
            ...
            //}
            a(".ace-nav > li").removeClass("light-blue dark light-pink grey");
            switch (d) {
                case "skin-1":
                    //a(".ace-nav > li").addClass("dark");
                    break;
                case "skin-2":
                    a(".ace-nav > li").addClass("light-pink");
                    break;
                case "skin-3":
                    a(".ace-nav > li").addClass("grey");
                    break;
                default:
                    a(".ace-nav > li").addClass("light-blue");
                    break;
            }
        })
    };
